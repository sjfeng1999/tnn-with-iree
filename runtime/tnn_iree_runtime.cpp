...
#include "runtime/tnn_module.h"

#include <stdio.h>
#include <type_traits>
#include <vector>

iree_vm_function_t LookupFunction(const char* function_name, iree_vm_module_t* bytecode_module) {
...
int main(int argc, char* argv[]){
    ...
    IREE_CHECK_OK(iree_tnn_module_create(iree_allocator_system(), hal_allocator_, &native_module_));
    ...
    IREE_CHECK_OK(
        iree_tools_utils_buffer_view_from_image_rescaled(
            ...
            hal_element_type, iree_hal_device_allocator(hal_device), input_range,
    ...
    IREE_CHECK_OK(iree_vm_invoke(context_, LookupFunction("predict", bytecode_module_),
    ...
    IREE_CHECK_OK(iree_custom_message_read_value(reversed_message, result_buffer,
